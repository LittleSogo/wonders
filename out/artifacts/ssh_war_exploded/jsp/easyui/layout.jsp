...
<div class="easyui-layout" id="cc" fit=true style="width: 600px; height: 400px;">
    <div region="north" data-options="collapsed:true" title="菜单栏" split="false"  style="height: 100px;">
    ...
    <div region="west" split="true" title="用户管理" style="width: 240px;">
        <div id="aa" fit=true class="easyui-accordion"style="width: 300px; height: 200px;">
            <div title="用户列表">
                <a title="003_form.jsp" >用户列表</a><br/><br/>
                <a title="001_datagrid.jsp" >用户权限</a><br/><br/>
                <a title="demo3.jsp" >bootstrap</a>
            </div>
            <div title="权限列表">
                <ul id="tabs"></ul>
            </div>
